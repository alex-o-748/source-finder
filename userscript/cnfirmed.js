// {{Wikipedia:USync |repo=https://github.com/alex-o-748/source-finder |ref=refs/heads/claude/cnfirmed-citation-tool-Av5p1 |path=userscript/cnfirmed.js}}
 ...
 * the user's own API key (stored in localStorage). No backend.
 *
