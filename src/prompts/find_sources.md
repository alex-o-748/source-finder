...
3. **Avoid** sources that appear on Wikipedia's deprecated-sources list (WP:RSP), including but not limited to: Daily Mail, The Sun, RT, Sputnik, Breitbart, Infowars, Natural News, Gateway Pundit, Zero Hedge, Epoch Times, Global Research, VeteransToday, WND, Newsmax, OAN, InfoWars.
4. Avoid user-generated content (Wikipedia itself, Wikia/Fandom, Reddit, Quora, random Medium/Substack posts) unless the post is by a subject-matter expert.
5. Return up to **5** ranked candidates.
