...
3. Prefer the **original publisher's article** over portals, aggregators, syndications, or pages that merely embed the original. For example, prefer the newspaper's own article over a third-party news portal that re-hosts or embeds it; for wire copy (Reuters, AP, AFP, etc.) prefer the wire service's own page over downstream republications.
